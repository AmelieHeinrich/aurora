...
struct fxaa_pass_data
{
    ...
    rhi_descriptor_set_layout fxaa_set_layout;
    rhi_descriptor_set fxaa_set;
};

void fxaa_pass_init(render_graph_node* node, render_graph_execute* execute)
{
...
void fxaa_pass_free(render_graph_node* node, render_graph_execute* execute)
{
    fxaa_pass_data* data = node->private_data;
...
void fxaa_pass_update(render_graph_node* node, render_graph_execute* execute)
{
    fxaa_pass_data* data = node->private_data;
...
void fxaa_pass_resize(render_graph_node* node, render_graph_execute* execute)
{
    fxaa_pass_data* data = node->private_data;
