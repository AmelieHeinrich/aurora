...
void update_render_graph(render_graph* graph, render_graph_execute* execute)
{
    ...
    if (!execute->freeze_frustrum)
    {
		...
		execute->camera.frustrum_planes[0].Y = matrix.Elements[3][1] + matrix.Elements[1][0];
		execute->camera.frustrum_planes[0].Z = matrix.Elements[3][2] + matrix.Elements[2][0];
		execute->camera.frustrum_planes[0].W = matrix.Elements[3][3] + matrix.Elements[3][0];

		execute->camera.frustrum_planes[1].X = matrix.Elements[3][0] + matrix.Elements[0][0];
		execute->camera.frustrum_planes[1].Y = matrix.Elements[3][1] + matrix.Elements[1][0];
		execute->camera.frustrum_planes[1].Z = matrix.Elements[3][2] + matrix.Elements[2][0];
		execute->camera.frustrum_planes[1].W = matrix.Elements[3][3] + matrix.Elements[3][0];

		execute->camera.frustrum_planes[2].X = matrix.Elements[3][0] - matrix.Elements[0][1];
		execute->camera.frustrum_planes[2].Y = matrix.Elements[3][1] - matrix.Elements[1][1];
		execute->camera.frustrum_planes[2].Z = matrix.Elements[3][2] - matrix.Elements[2][1];
		execute->camera.frustrum_planes[2].W = matrix.Elements[3][3] - matrix.Elements[3][1];

		execute->camera.frustrum_planes[3].X = matrix.Elements[3][0] + matrix.Elements[0][1];
		execute->camera.frustrum_planes[3].Y = matrix.Elements[3][1] + matrix.Elements[1][1];
		execute->camera.frustrum_planes[3].Z = matrix.Elements[3][2] + matrix.Elements[2][1];
	    execute->camera.frustrum_planes[3].W = matrix.Elements[3][3] + matrix.Elements[3][1];

		execute->camera.frustrum_planes[4].X = matrix.Elements[3][0] + matrix.Elements[0][2];
		execute->camera.frustrum_planes[4].Y = matrix.Elements[3][1] + matrix.Elements[1][2];
		execute->camera.frustrum_planes[4].Z = matrix.Elements[3][2] + matrix.Elements[2][2];
		execute->camera.frustrum_planes[4].W = matrix.Elements[3][3] + matrix.Elements[3][2];

		execute->camera.frustrum_planes[5].X = matrix.Elements[3][0] - matrix.Elements[0][2];
		execute->camera.frustrum_planes[5].Y = matrix.Elements[3][1] - matrix.Elements[1][2];
		execute->camera.frustrum_planes[5].Z = matrix.Elements[3][2] - matrix.Elements[2][2];
		execute->camera.frustrum_planes[5].W = matrix.Elements[3][3] - matrix.Elements[3][2];
